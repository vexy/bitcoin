...
This document provides guidelines for internationalization of the Vincoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `vincoin_en.ts` remains unchanged.
