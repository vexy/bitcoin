...
# Extract options
function __fish_vincoin_tx_get_options
...
# Extract commands
function __fish_vincoin_tx_get_commands
...
complete \
    --command vincoin-tx \
    --condition "not __fish_vincoin_seen_cmd (__fish_vincoin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_vincoin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command vincoin-tx \
    --arguments "(__fish_vincoin_tx_get_commands)" \
    --no-files
