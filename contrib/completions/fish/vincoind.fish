...
complete --command vincoind --no-files

# Extract options
function __fish_vincoind_get_options
...
complete \
    --command vincoind \
    --arguments "(__fish_vincoind_get_options --nofiles)"
