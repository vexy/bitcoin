...
complete --command vincoin-qt --no-files

# Extract options
function __fish_vincoinqt_get_options
...
complete \
    --command vincoin-qt \
    --arguments "(__fish_vincoinqt_get_options --nofiles)"
