...
This directory contains the files necessary to perform bootstrappable Vincoin
Core builds.
...
To build Vincoin Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Vincoin Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/vincoin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/vincoin-core/guix.sigs).
