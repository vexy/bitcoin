...
(define* (make-vincoin-cross-toolchain target
                                       #:key
...
desirable for building Vincoin Core release binaries."
...
;; failure; see https://github.com/vincoin/vincoin/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-vincoin-cross-toolchain target)))
