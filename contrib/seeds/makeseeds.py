#!/usr/bin/env python3
# Copyright (c) 2013-2022 The Vincoin Core developers
...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of vincoin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple vincoin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple vincoin ports', file=sys.stderr)
