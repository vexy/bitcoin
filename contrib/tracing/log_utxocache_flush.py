...
"""Example logging Vincoin Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/vincoind
...
def main(vincoind_path):
    ...
    b = BPF(text=program, usdt_contexts=[vincoind_with_usdts])
