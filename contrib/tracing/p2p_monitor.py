...
""" Interactive vincoind P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Vincoin Core can enable. It uses BCC
...
def main(vincoind_path):
    ...
    vincoind_with_usdts.enable_probe(
