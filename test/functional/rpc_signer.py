...
Verify that a vincoind node can use an external signer command.
...
class RPCSignerTest(VincoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart vincoind with -signer=<cmd>',
