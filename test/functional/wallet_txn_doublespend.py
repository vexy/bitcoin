...
class TxnMallTest(VincoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 VNC:
        ...
        # First: use raw transaction API to send 1240 VNC to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 VNC coin each
        ...
        # Node0's balance should be starting balance, plus 50VNC for another
        ...
        # Node0's total balance should be starting balance, plus 100VNC for
