...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the VincoinTestFramework
    pass


class ExampleTest(VincoinTestFramework):
    # Each functional test is a subclass of the VincoinTestFramework class.
    ...
    def custom_method(self):
        ...
        VincoinTestFramework class so other tests can use it."""
