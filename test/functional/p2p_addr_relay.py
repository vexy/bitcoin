    ...
    def on_addr(self, message):
        for addr in message.addrs:
            ...
            if self.test_addr_contents:
                ...
                # Todo: change 8343 and 8342 port number
                if not 6333 <= addr.port < 8343:
                    raise AssertionError("Invalid addr.port of {} (6333-8342 expected)".format(addr.port))
...
class AddrTest(VincoinTestFramework):
    counter = 0
