...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/vincoin/vincoin/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(VincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our vincoind node")
