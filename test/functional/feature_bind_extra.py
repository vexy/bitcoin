...
"""
Test starting vincoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(VincoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that vincoind has bound on "::1" (for RPC) and "::" (for P2P).
