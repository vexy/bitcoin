...
""" Tests the validation:* tracepoint API interface.
    See https://github.com/vincoin/vincoin/blob/master/doc/tracing.md#context-validation
"""
...
class ValidationTracepointTest(VincoinTestFramework):
    ...
    def run_test(self):
        ...
        # blocks.
        # See https://github.com/vincoin/vincoin/blob/master/doc/tracing.md#tracepoint-validationblock_connected
