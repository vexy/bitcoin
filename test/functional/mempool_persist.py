...
By default, vincoind will dump mempool on shutdown and
...
class MempoolPersistTest(VincoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent vincoind from writing mempool.dat to disk. Verify that `savemempool` fails")
