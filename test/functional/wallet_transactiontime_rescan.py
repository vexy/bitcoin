...
class TransactionTimeRescanTest(VincoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine VNC and create transactions
        ...
        # generate some vnc to create transactions and check blockcount
        ...
        # send 10 vnc to user's first watch-only address
        self.log.info('Send 10 vnc to user')
        ...
        # send 5 vnc to our second watch-only address
        self.log.info('Send 5 vnc to user')
        ...
        # send 1 vnc to our third watch-only address
        self.log.info('Send 1 vnc to user')
