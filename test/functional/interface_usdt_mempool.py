...
"""  Tests the mempool:* tracepoint API interface.
     See https://github.com/vincoin/vincoin/blob/master/doc/tracing.md#context-mempool
"""
...
class MempoolTracepointTest(VincoinTestFramework):
    ...
    def rejected_test(self):
        ...
        # https://github.com/vincoin/vincoin/issues/27380
