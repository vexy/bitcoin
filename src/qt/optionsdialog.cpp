      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->vincoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->vincoinAtStartup);
    ...
    ui->vincoinAtStartup->setToolTip(ui->vincoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->vincoinAtStartup->setText(ui->vincoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openVincoinConfButton->setToolTip(ui->openVincoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new VincoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->vincoinAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSVNControls);
...
void OptionsDialog::on_openVincoinConfButton_clicked()
{
