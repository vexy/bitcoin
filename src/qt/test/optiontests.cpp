...
{
    // Test regression https://github.com/vincoin/vincoin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/vincoin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/vincoin-core/gui/pull/568.
    // With fListen=false in ~/.config/Vincoin/Vincoin-Qt.conf and all else left as default,
    // vincoin-qt should set both -listen and -listenonion to false and start successfully.
