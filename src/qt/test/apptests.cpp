...
//! Entry point for VincoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &VincoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for VincoinGUI tests.
void AppTests::guiTests(VincoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &VincoinGUI::consoleShown, this, &AppTests::consoleTests);
