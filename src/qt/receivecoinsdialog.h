...
#ifndef VINCOIN_QT_RECEIVECOINSDIALOG_H
#define VINCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of vincoins */
...
#endif // VINCOIN_QT_RECEIVECOINSDIALOG_H
