...
#ifndef VINCOIN_QT_WALLETVIEW_H
#define VINCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a vincoin wallet, and offers access to
