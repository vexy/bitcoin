...
/** Interface from Qt to configuration data structure for Vincoin client.
...
public:
    ...
    VincoinUnit getDisplayUnit() const { return m_display_vincoin_unit; }
...
private:
    ...
    QString language;
    VincoinUnit m_display_vincoin_unit;
...
Q_SIGNALS:
    void displayUnitChanged(VincoinUnit unit);
