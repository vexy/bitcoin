...
#ifndef VINCOIN_QT_SENDCOINSENTRY_H
#define VINCOIN_QT_SENDCOINSENTRY_H
...
/**
 * A single entry in the dialog for sending vincoins.
 */
...
#endif // VINCOIN_QT_SENDCOINSENTRY_H
