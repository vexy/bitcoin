...
#ifndef VINCOIN_QT_GUIUTIL_H
#define VINCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Vincoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "vincoin:" URI into recipient object, return true on successful parsing
