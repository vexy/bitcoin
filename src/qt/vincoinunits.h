...
#ifndef VINCOIN_QT_VINCOINUNITS_H
#define VINCOIN_QT_VINCOINUNITS_H
...
/** Vincoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class VincoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit VincoinUnits(QObject *parent);

    /** Vincoin units.
      @note Source: https://en.vincoin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        VNC,
        mVNC,
