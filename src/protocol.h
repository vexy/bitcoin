...
#ifndef VINCOIN_PROTOCOL_H
#define VINCOIN_PROTOCOL_H
...
/**
 * Vincoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all Vincoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    ...
    // vincoin-development mailing list. Remember that service bits are just
