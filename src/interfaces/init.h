...
#ifndef VINCOIN_INTERFACES_INIT_H
#define VINCOIN_INTERFACES_INIT_H
...
//! (vincoin-gui, vincoin-node, vincoin-wallet, vincoind, vincoin-qt) and each
...
#endif // VINCOIN_INTERFACES_INIT_H
