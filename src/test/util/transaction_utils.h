// Copyright (c) 2019-2020 The Vincoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef VINCOIN_TEST_UTIL_TRANSACTION_UTILS_H
#define VINCOIN_TEST_UTIL_TRANSACTION_UTILS_H
...
#endif // VINCOIN_TEST_UTIL_TRANSACTION_UTILS_H
