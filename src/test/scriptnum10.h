...
#ifndef VINCOIN_TEST_SCRIPTNUM10_H
#define VINCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Vincoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // VINCOIN_TEST_SCRIPTNUM10_H
