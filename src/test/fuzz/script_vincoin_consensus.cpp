// Copyright (c) 2020 The Vincoin Core developers
...
FUZZ_TARGET(script_vincoin_consensus)
{
    ...
    (void)vincoinconsensus_verify_script(random_bytes_1.data(), random_bytes_1.size(), random_bytes_2.data(), random_bytes_2.size(), n_in, flags, err_p);
    (void)vincoinconsensus_verify_script_with_amount(random_bytes_1.data(), random_bytes_1.size(), money, random_bytes_2.data(), random_bytes_2.size(), n_in, flags, err_p);
    ...
    (void)vincoinconsensus_verify_script_with_spent_outputs(
