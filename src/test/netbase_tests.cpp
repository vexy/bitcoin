// Copyright (c) 2012-2022 The Vincoin Core developers
...
{
    BOOST_CHECK(TestSplitHost("www.vincoincore.org", "www.vincoincore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.vincoincore.org]", "www.vincoincore.org", 0));
    BOOST_CHECK(TestSplitHost("www.vincoincore.org:80", "www.vincoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.vincoincore.org]:80", "www.vincoincore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.vincoincore.org:65536", "www.vincoincore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.vincoincore.org:0", "www.vincoincore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.vincoincore.org:", "www.vincoincore.org:", 0, false));
}
