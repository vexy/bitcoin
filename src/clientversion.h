...
#error Client version information missing: version is not defined by vincoin-config.h or in any other way
#endif
...
/**
 * vincoind-res.rc includes this file, but it cannot cope with real c++ code.
