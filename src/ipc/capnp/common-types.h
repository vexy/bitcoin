...
#ifndef VINCOIN_IPC_CAPNP_COMMON_TYPES_H
#define VINCOIN_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common vincoin types.
namespace mp {
...
#endif // VINCOIN_IPC_CAPNP_COMMON_TYPES_H
