...
#ifndef VINCOIN_COMMON_ARGS_H
#define VINCOIN_COMMON_ARGS_H
...
extern const char * const VINCOIN_CONF_FILENAME;
extern const char * const VINCOIN_SETTINGS_FILENAME;
