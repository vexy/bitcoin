// Copyright (c) 2014-2020 The Vincoin Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between vincoin-cli and vincoind)
 * of a given instance of the Vincoin system.
 */
