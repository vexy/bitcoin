// Copyright (c) 2015-2021 The Vincoin Core developers
 ...
 */
#ifndef VINCOIN_TORCONTROL_H
#define VINCOIN_TORCONTROL_H
...
/****** Vincoin specific TorController implementation ********/
